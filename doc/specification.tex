...
\begin{figure}[H]
  ...
  \begin{tikzpicture}[node distance=1cm,auto]
    ...
    \node[rectroundnode,minimum width=10em](userinterface){User interface};
    \node[rectroundnode,right=3.5em of userinterface,minimum width=10em](jobserver){Job queuing server};
    ...
    \draw[arrow,->](userinterface.east) -- node[arrowlabel,above,text centered]{\small scenario} (jobserver.west);
