...
\requirement{REQ.0017}{Configurability of RF switches and attenuators}{
  ...
  The testbed shall support such a function.
}{}
\requirement{REQ.0018}{Abstraction interface to SDR application}{
  An wrapper application shall be developed to provide an abstraction layer (API) for executing SDR applications.
...
\requirement{REQ.0021}{Support of Robot Test Automation Framework}{
  ...
  A set of libraries shall be developed for the framework:
  \begin{itemize}
...
\requirement{REQ.0022}{Storing of experiment results in Hierarchical Data Format}{
  ...
  Testbed experiment which generated large amounts of data can benefit by HDF5\textsuperscript{\textregistered} support.
}{}
\requirement{REQ.0023}{Limitation of experiment running time}{
  There amount of time an experiment can be running shall be limited.
  A timeout shall be set for this purpose.
  This timeout shall be set to 30 minutes.
  After the time has elapsed, the execution of the experiment shall be terminated and the resources shall be freed and cleaned up.
}{
  The SDR Testbed has limited resources while the jobs are executed serially.
...
\requirement{REQ.0024}{Limitation of experiment results size}{
  There amount of data an experiment can produce shall be limited.
